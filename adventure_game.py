...
def invalid_response():
    print_pause("I'm sorry, there are no other options. Please respond with 1,"
                " or 2.")
...
def intro():
    ...
    print_pause("You decide to investigate where the first disappearance "
                "occurred.")
    print_pause("You heard rumors that a " + enemy + " may be hiding in the "
                "area.")
...
def field():
    print_pause("Inside the field, you look beyond it and see two different "
                "locations.")
    print_pause("1. An old dilapitated house")
    print_pause("2. A cave looming in the distance")
    response = input("Where would you like to go?")
    if response == '1':
        print_pause("You begin to march through the tall grass, towards the "
...
def item_gain():
    ...
    weapon = new_weapon
    print_pause("Just as you were about to leave, out of the corner of your "
    ...
    print_pause("With " + weapon + " in hand, you return to the field, more "
                "confident than ever.")
...
def victory():
    ...
    print_pause("You desperately dodge, roll, and weave between it's strikes.")
    ...
    print_pause("Still panting, you feel a great sense of pride and "
...
def failure():
    ...
    print_pause("The " + enemy + " towers above you, as your vision fades to "
                "black.")
    print_pause("Unfortunately, the creature has won. The townspeople will "
...
def house():
    ...
    print_pause("Great, dark, and ominous clouds are cast behind it's "
                "sagging, rickety roof.")
    print_pause("It's windows cracked, and broken. Shadows dance to and fro, "
    ...
    if monster_present is True:
        if check_weapon() is True:
            print_pause("With " + weapon + " in hand, you approach the door "
                        "of the house confidently.")
            response = input("Do you....\n"
                             "1. Knock on the door.\n"
                             "2. Go back to the field?\n")
            if response == '1':
                print_pause("You bang on the door, " + weapon + " poised to "
                            "strike")
                victory()
            elif response == '2':
                print_pause("Though you felt ready, you choose to head back "
                            "to the field.")
                field()
            else:
                invalid_response()
            ...
            print_pause("With only your little " + weapon + " in hand, you "
                        "nervously approach the door of the house.")
            response = input("Should you....\n"
                             "1. Knock on the door.\n"
            ...
            if response == '1':
                ...
                print_pause("You back away from the dilapitated house and "
                            "return to the field.")
                field()
            else:
                invalid_response()
        ...
        print_pause("With " + weapon + " in hand, you approach the door of "
                    "the house.")
        response = input("Do you....\n"
                         "1. Knock on the door.\n"
                         "2. Go back to the field?\n")
        if response == '1':
            print_pause("Your hand goes out to knock, as the door slowly "
                        "creaks open.")
            print_pause("Rats skitter across the floor, running to the "
                        "shadows, as you enter the domain.")
            print_pause("You search here and there, finding no monster or "
            ...
            print_pause("You back away from the door, and return to the "
                        "field.")
            field()
        else:
            invalid_response()
...
def cave():
    print_pause("Before you are several rock formations, and the opening to "
                "the large looming cave.")
    print_pause("Great stalagtites jut out from the roof and sides of the "
                "cave, forming a wicked smile.")
    print_pause("The shadows are deep, and you can hear the 'pit pat' of "
    ...
    if monster_present is True:
        if check_weapon() is True:
            print_pause("With " + weapon + " in hand, you confidently "
                        "approach the muddy entrance of the cave.")
            response = input("Do you....\n"
                             "1. Enter the shadows of the cave?\n"
                             "2. Go back to the field?\n")
            if response == '1':
                print_pause("You stomp your way forward, " + weapon +
                            " poised to strike")
                victory()
            elif response == '2':
                print_pause("Though you felt ready, you choose to head back "
            ...
            response = input("Should you....\n"
                             ...
                             "2. Run back to the field?\n")
            if response == '1':
                print_pause("With sweaty palms, you timidly step forth into "
                            "the damp and dark cave.")
                failure()
            elif response == '2':
                print_pause("You back away from the muddy entrance and return "
                            "to the field.")
                field()
            else:
                invalid_response()
        ...
        print_pause("With " + weapon + " in hand, you approach the muddy "
                    "entrance of the cave.")
        response = input("Do you....\n"
                         "1. Enter the shadows of the cave?\n"
                         "2. Go back to the field?\n")
        if response == '1':
            print_pause("You step forward into the dark of the cave, boots "
                        "sinking in mud.")
            print_pause("Bats screech and flap about, blowing past you, out "
